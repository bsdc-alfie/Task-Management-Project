        ...
        <form action="" method="post" class="form-control mt-5 p-4"
          ...
          style="font-weight: 700;">Login Into Your Account</h5>
            ...
            <div class="col mb-2 mt-4">
                <p class="text-center" 
                  style="font-weight: 600; color: navy;" ><a href="/pages/register.php"
                        style="text-decoration: none;">Create Account</a> OR <a href="/pages/reset_password.php"
